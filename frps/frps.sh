...
program_version_link="https://raw.githubusercontent.com/bravecheng/ShellScriptList/master/frps/version.sh"
str_install_shell=https://raw.githubusercontent.com/bravecheng/ShellScriptList/master/frps/frps.sh
shell_update(){
    fun_clangcn "clear"
