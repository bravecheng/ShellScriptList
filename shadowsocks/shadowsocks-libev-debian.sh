...
get_latest_version(){
    ...
    init_script_link="https://raw.githubusercontent.com/bravecheng/ShellScriptList/master/shadowsocks/shadowsocks-libev-debian"
}
...
pre_install(){
    ...
    read -p "(Default password: hello.world):" shadowsockspwd
    [ -z "${shadowsockspwd}" ] && shadowsockspwd="hello.world"
    echo
    echo "---------------------------"
